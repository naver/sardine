...
class VecEnv(ABC):
    ...
    def seed(self, seed: Optional[int] = None) -> List[Union[None, int]]:
        ...
        :return: Returns a list containing the seeds for each individual env.
            Note that all list elements may be None,
            if the env does not return anything when being seeded.
        """
        pass
    ...
    def getattr_depth_check(self, name: str, already_found: bool) -> Optional[str]:
        """Check if an attribute reference is being hidden
        in a recursive call to __getattr__
...
class VecEnvWrapper(VecEnv):
    ...
    def __getattr__(self, name: str) -> Any:
        ...
        Useful for accessing attributes from venvs which are
        wrapped with multiple wrappers
    ...
    def getattr_recursive(self, name: str) -> Any:
        ...
        if name in all_attributes:  # attribute is present in this wrapper
            ...
            # Attribute not present, child is wrapper.
            # Call getattr_recursive rather than getattr
    ...
    def getattr_depth_check(self, name: str, already_found: bool) -> str:
        ...
        if name in all_attributes and already_found:
            ...
            # we have found the first reference to the attribute.
